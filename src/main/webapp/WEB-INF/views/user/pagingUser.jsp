...
<script>
   ...
   $(function(){
	      $("#downUser").on("click", function(){
	         location.href='${cp }/user/excelDownload';
	      });
	   });
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         ...
         <div class="row">
            <div class="col-sm-8 blog-main">
               ...
               <button type="button" id="downUser" class="btn btn-default pull-right"> 사용자 엑셀다운로드</button>
                     ...
                     <ul class="pagination">
                        ...
                        <c:forEach begin="1" end="${pagination }" var="i">
                           <c:choose>
                              ...
                              <c:otherwise><li><a href="${cp}/user/pagingUser?page=${i }&pageSize=${pageVo.pageSize }">${i }</a></li></c:otherwise>
                           </c:choose>                        
                        </c:forEach>
                        <li class="next">
