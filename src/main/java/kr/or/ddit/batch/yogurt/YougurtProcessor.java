...
public class YougurtProcessor implements ItemProcessor<CycleVo, List<DailyVo>>{
    
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd");
			
	@Value("#{jobParmeters[dt]}")
	//private String dt;  //202102
	private Date dt;
	
	// dt: 202102, item : cid-1, pid-100, day-, cnt-1
	// ==>
	//					cid-1, pid-100, dt-0210201, cnt-1
	//					cid-1, pid-100, dt-0210208, cnt-1
	//					cid-1, pid-100, dt-0210215, cnt-1
	//					cid-1, pid-100, dt-0210222, cnt-1
